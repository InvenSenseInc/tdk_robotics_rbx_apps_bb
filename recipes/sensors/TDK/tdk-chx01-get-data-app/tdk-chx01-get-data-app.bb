...
# SRCREV = "${AUTOREV}"
SRCREV = "TDK-Robotics-RB5-0.1-test6"
...
"
#DEPENDS += "liblog"
LDFLAGS += "-lm -L${WORKDIR} -L${S} -Wl,-Bstatic -lInvnAlgoRangeFinder -lInvnAlgoFloorTypeFxp -lInvnAlgoCliffDetection -lInvnAlgoObstaclePosition -Wl,-Bdynamic"
